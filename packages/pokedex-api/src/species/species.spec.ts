...
describe("ZSpeciesApi", () => {
  ...
  beforeAll(async () => {
    const options = new ZDatabaseOptionsBuilder()
      .database("species-test-database")
      .timeout(30000)
      .build();
  ...
  beforeEach(async () => {
    ...
    await dal.create(ZPokedexCollection.Pokemon, [
      new ZPokeApiPokemonBuilder()
        .from(new ZPokemonBuilder().squirtle().build())
        .build(),
      new ZPokeApiPokemonBuilder()
        .from(new ZPokemonBuilder().charmander().build())
        .build(),
      new ZPokeApiPokemonBuilder()
        .from(new ZPokemonBuilder().bulbasaur().build())
        .build(),
      new ZPokeApiPokemonBuilder()
        .from(new ZPokemonBuilder().charizard().build())
        .build(),
      new ZPokeApiPokemonBuilder()
        .from(new ZPokemonBuilder().charizardMegaX().build())
        .build(),
      new ZPokeApiPokemonBuilder()
        .from(new ZPokemonBuilder().charizardMegaY().build())
        .build(),
      new ZPokeApiPokemonBuilder()
        .from(new ZPokemonBuilder().charizardGMax().build())
        .build(),
    ]);
  });
