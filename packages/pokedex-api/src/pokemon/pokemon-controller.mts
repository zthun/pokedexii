...
import { IZResourceGetService, IZResourceListService } from '../resource/resource-service.mjs';
...
export class ZPokemonController {
  ...
  @ApiParam({ type: 'string', name: 'identification', description: 'The id or name of the pokemon' })
  @Get(':identification')
